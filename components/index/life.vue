 ...
 * @version:
 * @Author: YoungW
 * @Date: 2020-06-30 18:41:18
 * @LastEditors: YoungW
 * @LastEditTime: 2020-06-30 19:01:51
-->
<template>
  <div class="m-life">
    <el-row>
      ...
      <el-col :span="6">
        <div class="m-life-login">
          ...
          <p><nuxt-link to="/register"><el-button-round size="medium">注册</el-button-round></nuxt-link></p>
          <p><nuxt-link to="/login"><el-button-round size="medium">立即登录</el-button-round></nuxt-link></p>
        </div>
      </el-col>
    </el-row>
    <el-row>
